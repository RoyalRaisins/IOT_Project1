package com.huawei.demo.product;

import com.huawei.demo.auth.Authentication;
import com.huawei.pojo.product.*;
...
public class CreateProduct {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, KeyManagementException, IOException {
        ...
        addProduct.setProtocol_type("LWM2M");
        ...
        StreamClosedHttpResponse httpResponse = httpUtils.doPost(url, header, JsonUtils.Obj2String(addProduct));
